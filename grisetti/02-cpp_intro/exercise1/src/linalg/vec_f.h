...
struct VecF {
  int dim; // guess what
  float* v; // elements to the data, stored in a pointer to the beginning of the elements
  ...
  // const before float& means the reference doesn't allow to change the referenced value
